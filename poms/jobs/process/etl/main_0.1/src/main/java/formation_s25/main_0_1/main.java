...
package formation_s25.main_0_1;
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				formation_s25.person_loading_0_1.person_loading childJob_tRunJob_1 = new formation_s25.person_loading_0_1.person_loading();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				formation_s25.person_linking_0_1.person_linking childJob_tRunJob_2 = new formation_s25.person_linking_0_1.person_linking();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				formation_s25.verify_nblines_0_1.verify_nblines childJob_tRunJob_3 = new formation_s25.verify_nblines_0_1.verify_nblines();
				// pass DataSources
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = main.class.getClassLoader()
					.getResourceAsStream("formation_s25/main_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 126112 characters generated by Talend Open Studio for Data Integration on the
 * 22 juin 2022 à 16:32:16 CEST
 ************************************************************************************************/