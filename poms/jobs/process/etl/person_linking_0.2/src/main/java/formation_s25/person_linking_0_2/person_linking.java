...
package formation_s25.person_linking_0_2;
...
/**
 * Job: person_linking Purpose: migrer les FKs de contact vers person<br>
 * Description:  <br>
...
public static class company_idStruct implements routines.system.IPersistableRow<company_idStruct> {
    final static byte[] commonByteArrayLock_FORMATION_S25_person_linking = new byte[0];
    static byte[] commonByteArray_FORMATION_S25_person_linking = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_FORMATION_S25_person_linking) {
...
company_id_tmp.company_id = (((row1.co_entreprise ) == null) ? null : (routines.system.TypeConvert.Long2Integer(row1.co_entreprise )));
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
		    ...
		    java.sql.Connection conn_tDBInput_3 = null;
				...
				String dbUser_tDBInput_3 = context.db_in_Login;
				
				
	final String decryptedPassword_tDBInput_3 = context.db_in_Password; 
				
				String dbPwd_tDBInput_3 = decryptedPassword_tDBInput_3;
				
        String properties_tDBInput_3 = context.db_in_AdditionalParams;
        if (properties_tDBInput_3 == null || properties_tDBInput_3.trim().length() == 0) {
            properties_tDBInput_3 = "";
        }
        String url_tDBInput_3 = "jdbc:mariadb://" + context.db_in_Server + ":" + context.db_in_Port + "/" + context.db_in_Database + "?" + properties_tDBInput_3;
...
location_id_tmp.location_id = (((row3.co_location ) == null) ? null : (routines.system.TypeConvert.Long2Integer(row3.co_location )));
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    java.sql.Connection conn_tDBInput_2 = null;
				...
				String dbUser_tDBInput_2 = context.db_out_Login;
				
				
	final String decryptedPassword_tDBInput_2 = context.db_out_Password; 
				
				String dbPwd_tDBInput_2 = decryptedPassword_tDBInput_2;
				
        String properties_tDBInput_2 = context.db_out_AdditionalParams;
        if (properties_tDBInput_2 == null || properties_tDBInput_2.trim().length() == 0) {
            properties_tDBInput_2 = "";
        }
        String url_tDBInput_2 = "jdbc:mariadb://" + context.db_out_Server + ":" + context.db_out_Port + "/" + context.db_out_Database + "?" + properties_tDBInput_2;
	...
	currentComponent="tDBInput_4";
		...
		int tos_count_tDBInput_4 = 0;
		    ...
		    java.sql.Connection conn_tDBInput_4 = null;
				...
				String dbUser_tDBInput_4 = context.db_out_Login;
				
				
	final String decryptedPassword_tDBInput_4 = context.db_out_Password; 
				
				String dbPwd_tDBInput_4 = decryptedPassword_tDBInput_4;
				
        String properties_tDBInput_4 = context.db_out_AdditionalParams;
        if (properties_tDBInput_4 == null || properties_tDBInput_4.trim().length() == 0) {
            properties_tDBInput_4 = "";
        }
        String url_tDBInput_4 = "jdbc:mariadb://" + context.db_out_Server + ":" + context.db_out_Port + "/" + context.db_out_Database + "?" + properties_tDBInput_4;
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_1";
        ...
        String url_tDBConnection_1 = "jdbc:mariadb://" + context.db_out_Server + ":" + context.db_out_Port + "/" + context.db_out_Database + "?" + properties_tDBConnection_1;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = person_linking.class.getClassLoader().getResourceAsStream("formation_s25/person_linking_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     165443 characters generated by Talend Open Studio for Data Integration 
 *     on the 24 juin 2022 à 12:02:38 CEST
 ************************************************************************************************/