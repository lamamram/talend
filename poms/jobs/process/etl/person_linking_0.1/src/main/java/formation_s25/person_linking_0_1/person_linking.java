...
package formation_s25.person_linking_0_1;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = person_linking.class.getClassLoader().getResourceAsStream("formation_s25/person_linking_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
