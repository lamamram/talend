...
package formation_s25.main_0_2;
...
/**
 * Job: main Purpose: point d'entrée du projet etl<br>
 * Description: <br>
 * 
...
public class main implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (db_out_Port != null) {
				...
				this.setProperty("db_out_Port", db_out_Port.toString());

			}

			if (db_out_Database != null) {

				this.setProperty("db_out_Database", db_out_Database.toString());

			}

			if (db_out_Login != null) {

				this.setProperty("db_out_Login", db_out_Login.toString());

			}

			if (db_out_AdditionalParams != null) {

				this.setProperty("db_out_AdditionalParams", db_out_AdditionalParams.toString());

			}

			if (db_out_Server != null) {

				this.setProperty("db_out_Server", db_out_Server.toString());

			}

			if (db_out_Password != null) {

				this.setProperty("db_out_Password", db_out_Password.toString());
		...
		public String db_out_Port;

		public String getDb_out_Port() {
			return this.db_out_Port;
		}

		public String db_out_Database;

		public String getDb_out_Database() {
			return this.db_out_Database;
		}

		public String db_out_Login;

		public String getDb_out_Login() {
			return this.db_out_Login;
		}

		public String db_out_AdditionalParams;

		public String getDb_out_AdditionalParams() {
			return this.db_out_AdditionalParams;
		}

		public String db_out_Server;

		public String getDb_out_Server() {
			return this.db_out_Server;
		}

		public java.lang.String db_out_Password;

		public java.lang.String getDb_out_Password() {
			return this.db_out_Password;
		}
	...
	public void tChronometerStop_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println(projectName + " - " + jobName + " executé en: " + "  " + timetChronometerStop_1
						+ " milliseconds");
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_FORMATION_S25_main = new byte[0];
		static byte[] commonByteArray_FORMATION_S25_main = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FORMATION_S25_main.length) {
					if (length < 1024 && commonByteArray_FORMATION_S25_main.length == 0) {
						commonByteArray_FORMATION_S25_main = new byte[1024];
					} else {
						commonByteArray_FORMATION_S25_main = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FORMATION_S25_main, 0, length);
				strReturn = new String(commonByteArray_FORMATION_S25_main, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_FORMATION_S25_main, 0, length);
				strReturn = new String(commonByteArray_FORMATION_S25_main, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FORMATION_S25_main) {
	...
	public void tContextDump_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.io.File file_tFileOutputProperties_1 = new java.io.File(context.data_dir + "prod.properties");
				...
				if (!parent_tFileOutputProperties_1.exists()) {
					...
					if (file_tFileOutputProperties_1.exists()) {
						file_tFileOutputProperties_1.delete();
					}
				}
				...
				for (java.util.Enumeration<?> en_tContextDump_1 = context.propertyNames(); en_tContextDump_1
					...
					properties_tFileOutputProperties_1.setProperty(row1.key, row1.value);
	...
	public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String properties_tDBConnection_1 = context.db_out_AdditionalParams;
				...
				String url_tDBConnection_1 = "jdbc:mariadb://" + context.db_out_Server + ":" + context.db_out_Port + "/"
						+ context.db_out_Database + "?" + properties_tDBConnection_1;
				String dbUser_tDBConnection_1 = context.db_out_Login;

				final String decryptedPassword_tDBConnection_1 = context.db_out_Password;
				String dbPwd_tDBConnection_1 = decryptedPassword_tDBConnection_1;

				java.sql.Connection conn_tDBConnection_1 = null;

				String sharedConnectionName_tDBConnection_1 = "global_db_out";
				conn_tDBConnection_1 = SharedDBConnection.getDBConnection("org.mariadb.jdbc.Driver",
				...
				globalMap.put("db_tDBConnection_1", context.db_out_Database);
	...
	public void tDie_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					tLogCatcher_1.addMessage("tDie", "tDie_1", 6, "context issue", 42);
					tLogCatcher_1Process(globalMap);

					globalMap.put("tDie_1_DIE_PRIORITY", 6);
					System.err.println("context issue");

					globalMap.put("tDie_1_DIE_MESSAGE", "context issue");
					globalMap.put("tDie_1_DIE_MESSAGES", "context issue");
	...
	public void tFileExist_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.io.File file_tFileExist_1 = new java.io.File(context.data_dir + "prod.properties");
				...
				globalMap.put("tFileExist_1_FILENAME", context.data_dir + "prod.properties");
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tFileExist_1:OnSubjobOk", "",
	...
	public void tFileInputProperties_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.io.File file_tFileInputProperties_1 = new java.io.File(context.data_dir + "prod.properties");
				...
				try {
					...
					while (enumeration_tFileInputProperties_1.hasMoreElements()) {
						...
						if ((key_tContextLoad_1 != null) && ("db_out_Password".equals(key_tContextLoad_1)))
							currentValue_tContextLoad_1 = currentValue_tContextLoad_1.replaceAll(".", "*");
						if ((key_tContextLoad_1 != null) && ("db_in_Password".equals(key_tContextLoad_1)))
							currentValue_tContextLoad_1 = currentValue_tContextLoad_1.replaceAll(".", "*");

						if (tmp_key_tContextLoad_1 != null) {
							try {
								if (key_tContextLoad_1 != null && "db_out_Port".equals(key_tContextLoad_1)) {
									context.db_out_Port = value_tContextLoad_1;
								}

								if (key_tContextLoad_1 != null && "db_out_Database".equals(key_tContextLoad_1)) {
									context.db_out_Database = value_tContextLoad_1;
								}

								if (key_tContextLoad_1 != null && "db_out_Login".equals(key_tContextLoad_1)) {
									context.db_out_Login = value_tContextLoad_1;
								}

								if (key_tContextLoad_1 != null
										&& "db_out_AdditionalParams".equals(key_tContextLoad_1)) {
									context.db_out_AdditionalParams = value_tContextLoad_1;
								}

								if (key_tContextLoad_1 != null && "db_out_Server".equals(key_tContextLoad_1)) {
									context.db_out_Server = value_tContextLoad_1;
								}

								if (key_tContextLoad_1 != null && "db_out_Password".equals(key_tContextLoad_1)) {
									context.db_out_Password = value_tContextLoad_1;
								}

								if (key_tContextLoad_1 != null && "db_in_Login".equals(key_tContextLoad_1)) {
									context.db_in_Login = value_tContextLoad_1;
								}

								if (key_tContextLoad_1 != null && "db_in_AdditionalParams".equals(key_tContextLoad_1)) {
									context.db_in_AdditionalParams = value_tContextLoad_1;
								}

								if (key_tContextLoad_1 != null && "db_in_Server".equals(key_tContextLoad_1)) {
									context.db_in_Server = value_tContextLoad_1;
								}

								if (key_tContextLoad_1 != null && "db_in_Password".equals(key_tContextLoad_1)) {
									context.db_in_Password = value_tContextLoad_1;
								}

								if (key_tContextLoad_1 != null && "db_in_Database".equals(key_tContextLoad_1)) {
									context.db_in_Database = value_tContextLoad_1;
								}

								if (key_tContextLoad_1 != null && "db_in_Port".equals(key_tContextLoad_1)) {
									context.db_in_Port = value_tContextLoad_1;
								}
				...
				parametersToEncrypt_tContextLoad_1.add("db_out_Password");

				parametersToEncrypt_tContextLoad_1.add("db_in_Password");
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println(context.db_in_Port);
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_1 {
					private void transmitContext_0() {
						parentContextMap_tRunJob_1.put("db_out_Port", context.db_out_Port);
						paraList_tRunJob_1.add("--context_type " + "db_out_Port" + "=" + "id_String");
						parentContextMap_tRunJob_1.put("db_out_Database", context.db_out_Database);
						paraList_tRunJob_1.add("--context_type " + "db_out_Database" + "=" + "id_String");
						parentContextMap_tRunJob_1.put("db_out_Login", context.db_out_Login);
						paraList_tRunJob_1.add("--context_type " + "db_out_Login" + "=" + "id_String");
						parentContextMap_tRunJob_1.put("db_out_AdditionalParams", context.db_out_AdditionalParams);
						paraList_tRunJob_1.add("--context_type " + "db_out_AdditionalParams" + "=" + "id_String");
						parentContextMap_tRunJob_1.put("db_out_Server", context.db_out_Server);
						paraList_tRunJob_1.add("--context_type " + "db_out_Server" + "=" + "id_String");
						parentContextMap_tRunJob_1.put("db_out_Password", context.db_out_Password);
						paraList_tRunJob_1.add("--context_type " + "db_out_Password" + "=" + "id_Password");
						parentContextMap_tRunJob_1.put("db_in_Login", context.db_in_Login);
						paraList_tRunJob_1.add("--context_type " + "db_in_Login" + "=" + "id_String");
						parentContextMap_tRunJob_1.put("db_in_AdditionalParams", context.db_in_AdditionalParams);
						paraList_tRunJob_1.add("--context_type " + "db_in_AdditionalParams" + "=" + "id_String");
						parentContextMap_tRunJob_1.put("db_in_Server", context.db_in_Server);
						paraList_tRunJob_1.add("--context_type " + "db_in_Server" + "=" + "id_String");
						parentContextMap_tRunJob_1.put("db_in_Password", context.db_in_Password);
						paraList_tRunJob_1.add("--context_type " + "db_in_Password" + "=" + "id_Password");
						parentContextMap_tRunJob_1.put("db_in_Database", context.db_in_Database);
						paraList_tRunJob_1.add("--context_type " + "db_in_Database" + "=" + "id_String");
						parentContextMap_tRunJob_1.put("db_in_Port", context.db_in_Port);
						paraList_tRunJob_1.add("--context_type " + "db_in_Port" + "=" + "id_String");
						parentContextMap_tRunJob_1.put("data_dir", context.data_dir);
						paraList_tRunJob_1.add("--context_type " + "data_dir" + "=" + "id_String");
					}
				...
				formation_s25.person_loading_0_2.person_loading childJob_tRunJob_1 = new formation_s25.person_loading_0_2.person_loading();
				// pass DataSources
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_2 {
					private void transmitContext_0() {
						parentContextMap_tRunJob_2.put("db_out_Port", context.db_out_Port);
						paraList_tRunJob_2.add("--context_type " + "db_out_Port" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("db_out_Database", context.db_out_Database);
						paraList_tRunJob_2.add("--context_type " + "db_out_Database" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("db_out_Login", context.db_out_Login);
						paraList_tRunJob_2.add("--context_type " + "db_out_Login" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("db_out_AdditionalParams", context.db_out_AdditionalParams);
						paraList_tRunJob_2.add("--context_type " + "db_out_AdditionalParams" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("db_out_Server", context.db_out_Server);
						paraList_tRunJob_2.add("--context_type " + "db_out_Server" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("db_out_Password", context.db_out_Password);
						paraList_tRunJob_2.add("--context_type " + "db_out_Password" + "=" + "id_Password");
						parentContextMap_tRunJob_2.put("db_in_Login", context.db_in_Login);
						paraList_tRunJob_2.add("--context_type " + "db_in_Login" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("db_in_AdditionalParams", context.db_in_AdditionalParams);
						paraList_tRunJob_2.add("--context_type " + "db_in_AdditionalParams" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("db_in_Server", context.db_in_Server);
						paraList_tRunJob_2.add("--context_type " + "db_in_Server" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("db_in_Password", context.db_in_Password);
						paraList_tRunJob_2.add("--context_type " + "db_in_Password" + "=" + "id_Password");
						parentContextMap_tRunJob_2.put("db_in_Database", context.db_in_Database);
						paraList_tRunJob_2.add("--context_type " + "db_in_Database" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("db_in_Port", context.db_in_Port);
						paraList_tRunJob_2.add("--context_type " + "db_in_Port" + "=" + "id_String");
						parentContextMap_tRunJob_2.put("data_dir", context.data_dir);
						paraList_tRunJob_2.add("--context_type " + "data_dir" + "=" + "id_String");
					}
				...
				formation_s25.person_linking_0_2.person_linking childJob_tRunJob_2 = new formation_s25.person_linking_0_2.person_linking();
				// pass DataSources
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_3 {
					private void transmitContext_0() {
						parentContextMap_tRunJob_3.put("db_out_Port", context.db_out_Port);
						paraList_tRunJob_3.add("--context_type " + "db_out_Port" + "=" + "id_String");
						parentContextMap_tRunJob_3.put("db_out_Database", context.db_out_Database);
						paraList_tRunJob_3.add("--context_type " + "db_out_Database" + "=" + "id_String");
						parentContextMap_tRunJob_3.put("db_out_Login", context.db_out_Login);
						paraList_tRunJob_3.add("--context_type " + "db_out_Login" + "=" + "id_String");
						parentContextMap_tRunJob_3.put("db_out_AdditionalParams", context.db_out_AdditionalParams);
						paraList_tRunJob_3.add("--context_type " + "db_out_AdditionalParams" + "=" + "id_String");
						parentContextMap_tRunJob_3.put("db_out_Server", context.db_out_Server);
						paraList_tRunJob_3.add("--context_type " + "db_out_Server" + "=" + "id_String");
						parentContextMap_tRunJob_3.put("db_out_Password", context.db_out_Password);
						paraList_tRunJob_3.add("--context_type " + "db_out_Password" + "=" + "id_Password");
						parentContextMap_tRunJob_3.put("db_in_Login", context.db_in_Login);
						paraList_tRunJob_3.add("--context_type " + "db_in_Login" + "=" + "id_String");
						parentContextMap_tRunJob_3.put("db_in_AdditionalParams", context.db_in_AdditionalParams);
						paraList_tRunJob_3.add("--context_type " + "db_in_AdditionalParams" + "=" + "id_String");
						parentContextMap_tRunJob_3.put("db_in_Server", context.db_in_Server);
						paraList_tRunJob_3.add("--context_type " + "db_in_Server" + "=" + "id_String");
						parentContextMap_tRunJob_3.put("db_in_Password", context.db_in_Password);
						paraList_tRunJob_3.add("--context_type " + "db_in_Password" + "=" + "id_Password");
						parentContextMap_tRunJob_3.put("db_in_Database", context.db_in_Database);
						paraList_tRunJob_3.add("--context_type " + "db_in_Database" + "=" + "id_String");
						parentContextMap_tRunJob_3.put("db_in_Port", context.db_in_Port);
						paraList_tRunJob_3.add("--context_type " + "db_in_Port" + "=" + "id_String");
						parentContextMap_tRunJob_3.put("data_dir", context.data_dir);
						paraList_tRunJob_3.add("--context_type " + "data_dir" + "=" + "id_String");
					}
				...
				formation_s25.verify_nblines_0_2.verify_nblines childJob_tRunJob_3 = new formation_s25.verify_nblines_0_2.verify_nblines();
				// pass DataSources
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = main.class.getClassLoader()
					.getResourceAsStream("formation_s25/main_0_2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
			...
			class ContextProcessing {
				private void processContext_0() {
					context.setContextType("db_out_Port", "id_String");
					if (context.getStringValue("db_out_Port") == null) {
						context.db_out_Port = null;
					} else {
						context.db_out_Port = (String) context.getProperty("db_out_Port");
					}
					context.setContextType("db_out_Database", "id_String");
					if (context.getStringValue("db_out_Database") == null) {
						context.db_out_Database = null;
					} else {
						context.db_out_Database = (String) context.getProperty("db_out_Database");
					}
					context.setContextType("db_out_Login", "id_String");
					if (context.getStringValue("db_out_Login") == null) {
						context.db_out_Login = null;
					} else {
						context.db_out_Login = (String) context.getProperty("db_out_Login");
					}
					context.setContextType("db_out_AdditionalParams", "id_String");
					if (context.getStringValue("db_out_AdditionalParams") == null) {
						context.db_out_AdditionalParams = null;
					} else {
						context.db_out_AdditionalParams = (String) context.getProperty("db_out_AdditionalParams");
					}
					context.setContextType("db_out_Server", "id_String");
					if (context.getStringValue("db_out_Server") == null) {
						context.db_out_Server = null;
					} else {
						context.db_out_Server = (String) context.getProperty("db_out_Server");
					}
					context.setContextType("db_out_Password", "id_Password");
					if (context.getStringValue("db_out_Password") == null) {
						context.db_out_Password = null;
					} else {
						String pwd_db_out_Password_value = context.getProperty("db_out_Password");
						context.db_out_Password = null;
						if (pwd_db_out_Password_value != null) {
							if (context_param.containsKey("db_out_Password")) {// no need to decrypt if it come from
																				// program argument or parent job
																				// runtime
								context.db_out_Password = pwd_db_out_Password_value;
							} else if (!pwd_db_out_Password_value.isEmpty()) {
								try {
									context.db_out_Password = routines.system.PasswordEncryptUtil
											.decryptPassword(pwd_db_out_Password_value);
									context.put("db_out_Password", context.db_out_Password);
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("db_out_Port")) {
				context.db_out_Port = (String) parentContextMap.get("db_out_Port");
			}
			if (parentContextMap.containsKey("db_out_Database")) {
				context.db_out_Database = (String) parentContextMap.get("db_out_Database");
			}
			if (parentContextMap.containsKey("db_out_Login")) {
				context.db_out_Login = (String) parentContextMap.get("db_out_Login");
			}
			if (parentContextMap.containsKey("db_out_AdditionalParams")) {
				context.db_out_AdditionalParams = (String) parentContextMap.get("db_out_AdditionalParams");
			}
			if (parentContextMap.containsKey("db_out_Server")) {
				context.db_out_Server = (String) parentContextMap.get("db_out_Server");
			}
			if (parentContextMap.containsKey("db_out_Password")) {
				context.db_out_Password = (java.lang.String) parentContextMap.get("db_out_Password");
			}
		...
		parametersToEncrypt.add("db_out_Password");
...
/************************************************************************************************
 * 148140 characters generated by Talend Open Studio for Data Integration on the
 * 24 juin 2022 à 12:02:40 CEST
 ************************************************************************************************/