...
package formation_s25.advanced_tmap_0_1;
...
/**
 * Job: advanced_tmap Purpose: utiliser les filtres d'entrée sortie<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class advanced_tmap implements TalendJob {
...
public String getData_dir(){
	...
	private final String jobName = "advanced_tmap";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				advanced_tmap.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(advanced_tmap.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class brown_petsStruct implements routines.system.IPersistableRow<brown_petsStruct> {
    final static byte[] commonByteArrayLock_FORMATION_S25_advanced_tmap = new byte[0];
    static byte[] commonByteArray_FORMATION_S25_advanced_tmap = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final brown_petsStruct other = (brown_petsStruct) obj;
	...
	public void copyDataTo(brown_petsStruct other) {
	...
	public void copyKeysDataTo(brown_petsStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_FORMATION_S25_advanced_tmap.length) {
				if(length < 1024 && commonByteArray_FORMATION_S25_advanced_tmap.length == 0) {
   					commonByteArray_FORMATION_S25_advanced_tmap = new byte[1024];
				} else {
   					commonByteArray_FORMATION_S25_advanced_tmap = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_FORMATION_S25_advanced_tmap, 0, length);
			strReturn = new String(commonByteArray_FORMATION_S25_advanced_tmap, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_FORMATION_S25_advanced_tmap, 0, length);
			strReturn = new String(commonByteArray_FORMATION_S25_advanced_tmap, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_FORMATION_S25_advanced_tmap) {
     ...
     * Compare keys
     */
    public int compareTo(brown_petsStruct other) {
...
public static class name_with_BStruct implements routines.system.IPersistableRow<name_with_BStruct> {
    final static byte[] commonByteArrayLock_FORMATION_S25_advanced_tmap = new byte[0];
    static byte[] commonByteArray_FORMATION_S25_advanced_tmap = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final name_with_BStruct other = (name_with_BStruct) obj;
	...
	public void copyDataTo(name_with_BStruct other) {
	...
	public void copyKeysDataTo(name_with_BStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(name_with_BStruct other) {
...
public static class filter_rejecctsStruct implements routines.system.IPersistableRow<filter_rejecctsStruct> {
    final static byte[] commonByteArrayLock_FORMATION_S25_advanced_tmap = new byte[0];
    static byte[] commonByteArray_FORMATION_S25_advanced_tmap = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final filter_rejecctsStruct other = (filter_rejecctsStruct) obj;
	...
	public void copyDataTo(filter_rejecctsStruct other) {
	...
	public void copyKeysDataTo(filter_rejecctsStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(filter_rejecctsStruct other) {
...
brown_petsStruct brown_pets = new brown_petsStruct();
name_with_BStruct name_with_B = new name_with_BStruct();
filter_rejecctsStruct filter_rejeccts = new filter_rejecctsStruct();
	...
	currentComponent="tLogRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"brown_pets");
					}
 ...
 */
	...
	currentComponent="tLogRow_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"name_with_B");
					}
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"co_id","co_name","name","age","color",});        
 ...
 */
	...
	currentComponent="tLogRow_3";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"filter_rejeccts");
					}
	...
	///////////////////////
        ...
        util_tLogRow_3.addRow(new String[]{"co_id","co_name","name","age","color",});        
...
// # Lookup's keys initialization
		...
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<row1Struct> tHash_Lookup_Cache_row1 = 
			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
				<row1Struct>getLookup(org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.FIRST_MATCH);
...
brown_petsStruct brown_pets_tmp = new brown_petsStruct();
name_with_BStruct name_with_B_tmp = new name_with_BStruct();
filter_rejecctsStruct filter_rejeccts_tmp = new filter_rejecctsStruct();
// ###############################
...
org.dom4j.XPath x_tFileInputXML_1 = doc_tFileInputXML_1.createXPath(nsTool_tFileInputXML_1.addDefaultNSPrefix("/pets/pet"));  
...
java.util.Map<Integer,org.dom4j.XPath> xpaths_tFileInputXML_1=new java.util.HashMap<Integer,org.dom4j.XPath>();
	...
	org.dom4j.XPath xpath_0 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix("name","/pets/pet"));
	xpath_0.setNamespaceURIs(xmlNameSpaceMap);
	
			xpaths.put(0,xpath_0);
			
	org.dom4j.XPath xpath_1 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix("age","/pets/pet"));
	xpath_1.setNamespaceURIs(xmlNameSpaceMap);
	
			xpaths.put(1,xpath_1);
			
	org.dom4j.XPath xpath_2 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix("type/species","/pets/pet"));
	xpath_2.setNamespaceURIs(xmlNameSpaceMap);
	
			xpaths.put(2,xpath_2);
			
	org.dom4j.XPath xpath_3 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix("color","/pets/pet"));
	xpath_3.setNamespaceURIs(xmlNameSpaceMap);
	
			xpaths.put(3,xpath_3);
			
	org.dom4j.XPath xpath_4 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix("contact","/pets/pet"));
 					    ...
 					    boolean forceLooprow1 = false;
 							...
 							row1Struct row1ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row1__co_id = (((row2.contact ) == null) ? null : (routines.system.TypeConvert.Integer2Long(row2.contact )));
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.city_id = (((row1.co_location ) == null) ? null : (routines.system.TypeConvert.Long2Integer(row1.co_location )));
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.city_id = '" + row3HashKey.city_id + "'");
								} // G 071
...
brown_pets = null;
name_with_B = null;
filter_rejeccts = null;

boolean rejected_tMap_1 = true;
if(!rejectedInnerJoin_tMap_1 ) {

// # Output table : 'brown_pets'
// # Filter conditions 
if( 

"marron".equals(row2.color.toLowerCase())

 ) {
rejected_tMap_1 = false;
brown_pets_tmp.co_id = row1.co_id ;
brown_pets_tmp.owner_name = row1.co_firstname  + " " +row1.co_name;
brown_pets_tmp.name = row2.name ;
brown_pets_tmp.age = row2.age ;
brown_pets_tmp.color = row2.color ;
brown_pets_tmp.city_name = row3.city_name ;
brown_pets = brown_pets_tmp;
} // closing filter/reject

// # Output table : 'name_with_B'
// # Filter conditions 
if( 

row2.name.startsWith("B")

 ) {
rejected_tMap_1 = false;
name_with_B_tmp.co_id = row1.co_id ;
name_with_B_tmp.co_name = row1.co_name ;
name_with_B_tmp.name = row2.name ;
name_with_B_tmp.age = row2.age ;
name_with_B_tmp.color = row2.color ;
name_with_B = name_with_B_tmp;
} // closing filter/reject
...
// # Output reject table : 'filter_rejeccts'
// # Filter conditions 
if( rejected_tMap_1 ) {
filter_rejeccts_tmp.co_id = row1.co_id ;
filter_rejeccts_tmp.co_name = row1.co_name ;
filter_rejeccts_tmp.name = row2.name ;
filter_rejeccts_tmp.age = row2.age ;
filter_rejeccts_tmp.color = row2.color ;
filter_rejeccts = filter_rejeccts_tmp;
} // closing filter/reject
// ###############################
...
///////////////////////		
				...
				String[] row_tLogRow_1 = new String[6];
                 ...
                 row_tLogRow_1[0]=    						    
				                String.valueOf(brown_pets.co_id)			
					          ;	
										
    			   				
	    		if(brown_pets.owner_name != null) { //              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(brown_pets.owner_name)			
					          ;	
							
	    		} //			
    			   				
	    		if(brown_pets.name != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(brown_pets.name)			
					          ;	
							
	    		} //			
    			   				
	    		if(brown_pets.age != null) { //              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(brown_pets.age)			
					          ;	
							
	    		} //			
    			   				
	    		if(brown_pets.color != null) { //              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(brown_pets.color)			
					          ;	
							
	    		} //			
    			   				
	    		if(brown_pets.city_name != null) { //              
                 row_tLogRow_1[5]=    						    
				                String.valueOf(brown_pets.city_name)			
					          ;	
...
} // End of branch "brown_pets"




// Start of branch "name_with_B"
if(name_with_B != null) { 
...
///////////////////////		
				...
				String[] row_tLogRow_2 = new String[5];
                 ...
                 row_tLogRow_2[0]=    						    
				                String.valueOf(name_with_B.co_id)			
					          ;	
										
    			   				
	    		if(name_with_B.co_name != null) { //              
                 row_tLogRow_2[1]=    						    
				                String.valueOf(name_with_B.co_name)			
					          ;	
							
	    		} //			
    			   				
	    		if(name_with_B.name != null) { //              
                 row_tLogRow_2[2]=    						    
				                String.valueOf(name_with_B.name)			
					          ;	
							
	    		} //			
    			   				
	    		if(name_with_B.age != null) { //              
                 row_tLogRow_2[3]=    						    
				                String.valueOf(name_with_B.age)			
					          ;	
							
	    		} //			
    			   				
	    		if(name_with_B.color != null) { //              
                 row_tLogRow_2[4]=    						    
				                String.valueOf(name_with_B.color)			
					          ;	
...
} // End of branch "name_with_B"




// Start of branch "filter_rejeccts"
if(filter_rejeccts != null) { 
...
///////////////////////		
				...
				String[] row_tLogRow_3 = new String[5];
                 ...
                 row_tLogRow_3[0]=    						    
				                String.valueOf(filter_rejeccts.co_id)			
					          ;	
										
    			   				
	    		if(filter_rejeccts.co_name != null) { //              
                 row_tLogRow_3[1]=    						    
				                String.valueOf(filter_rejeccts.co_name)			
					          ;	
							
	    		} //			
    			   				
	    		if(filter_rejeccts.name != null) { //              
                 row_tLogRow_3[2]=    						    
				                String.valueOf(filter_rejeccts.name)			
					          ;	
							
	    		} //			
    			   				
	    		if(filter_rejeccts.age != null) { //              
                 row_tLogRow_3[3]=    						    
				                String.valueOf(filter_rejeccts.age)			
					          ;	
							
	    		} //			
    			   				
	    		if(filter_rejeccts.color != null) { //              
                 row_tLogRow_3[4]=    						    
				                String.valueOf(filter_rejeccts.color)			
					          ;	
...
///////////////////////    			
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"brown_pets");
			  	}
...
///////////////////////    			
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"name_with_B");
			  	}
...
///////////////////////    			
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"filter_rejeccts");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row1";
		...
		int tos_count_tAdvancedHash_row1 = 0;
			   		...
			   		// source node:tDBInput_1 - inputs:() outputs:(row1,row1) | target node:tAdvancedHash_row1 - inputs:(row1) outputs:()
			   		// linked node: tMap_1 - inputs:(row2,row1,row3) outputs:(brown_pets,name_with_B,filter_rejeccts)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// source node:tRowGenerator_1 - inputs:(after_tFileInputXML_1) outputs:(row3,row3) | target node:tAdvancedHash_row3 - inputs:(row3) outputs:()
			   		// linked node: tMap_1 - inputs:(row2,row1,row3) outputs:(brown_pets,name_with_B,filter_rejeccts)
 ...
 */
    ...
    public static void main(String[] args){
        final advanced_tmap advanced_tmapClass = new advanced_tmap();

        int exitCode = advanced_tmapClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = advanced_tmap.class.getClassLoader().getResourceAsStream("formation_s25/advanced_tmap_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = advanced_tmap.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        if(context.getStringValue("nb_cpus") == null) {
                            ...
                            try{
                                context.nb_cpus=routines.system.ParserUtils.parseTo_Integer (context.getProperty("nb_cpus"));
                            } catch(NumberFormatException e){
                                System.err.println(String.format("Null value will be used for context parameter %s: %s", "nb_cpus", e.getMessage()));
                                context.nb_cpus=null;
                            }
                        }
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : advanced_tmap");
        }
...
/************************************************************************************************
 *     166057 characters generated by Talend Open Studio for Data Integration 
 *     on the 24 juin 2022 à 16:53:38 CEST
 ************************************************************************************************/