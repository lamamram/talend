...
package formation_s25.advanced_lookup_0_1;
...
/**
 * Job: advanced_lookup Purpose: accélérer une jointure dont le lookup est bcp + grand que le flux principal<br>
 * Description:  <br>
...
public static class owner_petsStruct implements routines.system.IPersistableRow<owner_petsStruct> {
    final static byte[] commonByteArrayLock_FORMATION_S25_advanced_lookup = new byte[0];
    static byte[] commonByteArray_FORMATION_S25_advanced_lookup = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_FORMATION_S25_advanced_lookup.length) {
				if(length < 1024 && commonByteArray_FORMATION_S25_advanced_lookup.length == 0) {
   					commonByteArray_FORMATION_S25_advanced_lookup = new byte[1024];
				} else {
   					commonByteArray_FORMATION_S25_advanced_lookup = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_FORMATION_S25_advanced_lookup, 0, length);
			strReturn = new String(commonByteArray_FORMATION_S25_advanced_lookup, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_FORMATION_S25_advanced_lookup, 0, length);
			strReturn = new String(commonByteArray_FORMATION_S25_advanced_lookup, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_FORMATION_S25_advanced_lookup) {
...
///////////////////////		
				...
				String[] row_tLogRow_1 = new String[6];
                 ...
                 row_tLogRow_1[0]=    						    
				                String.valueOf(owner_pets.co_id)			
					          ;	
										
    			   				
	    		if(owner_pets.owner_name != null) { //              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(owner_pets.owner_name)			
					          ;	
	    		...
	    		if(owner_pets.name != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(owner_pets.name)			
					          ;	
	    		...
	    		if(owner_pets.color != null) { //              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(owner_pets.color)			
					          ;	
	    		...
	    		if(owner_pets.city_name != null) { //              
                 row_tLogRow_1[5]=    						    
				                String.valueOf(owner_pets.city_name)			
					          ;	
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = advanced_lookup.class.getClassLoader().getResourceAsStream("formation_s25/advanced_lookup_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     130314 characters generated by Talend Open Studio for Data Integration 
