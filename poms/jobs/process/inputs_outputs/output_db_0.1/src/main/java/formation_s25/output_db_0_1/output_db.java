...
package formation_s25.output_db_0_1;
...
/**
 * Job: output_db Purpose: insérer le contenu d'un csv dans une table sql<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class output_db implements TalendJob {
	...
	private final String jobName = "output_db";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(output_db.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
		final static byte[] commonByteArrayLock_FORMATION_S25_output_db = new byte[0];
		static byte[] commonByteArray_FORMATION_S25_output_db = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FORMATION_S25_output_db.length) {
					if (length < 1024 && commonByteArray_FORMATION_S25_output_db.length == 0) {
						commonByteArray_FORMATION_S25_output_db = new byte[1024];
					} else {
						commonByteArray_FORMATION_S25_output_db = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FORMATION_S25_output_db, 0, length);
				strReturn = new String(commonByteArray_FORMATION_S25_output_db, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_FORMATION_S25_output_db, 0, length);
				strReturn = new String(commonByteArray_FORMATION_S25_output_db, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FORMATION_S25_output_db) {
	...
	public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FORMATION_S25_output_db) {
				...
				try {
					...
					this.response = (Object) dis.readObject();
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("response=" + String.valueOf(response));
			sb.append("]");
	...
	public void tDBRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_2.addRow(new String[] { "mode", });
...
///////////////////////    			
				...
				String driverClass_tDBRow_1 = "org.mariadb.jdbc.Driver";
				java.lang.Class jdbcclazz_tDBRow_1 = java.lang.Class.forName(driverClass_tDBRow_1);

				String properties_tDBRow_1 = context.db_in_AdditionalParams;
				...
				String url_tDBRow_1 = "jdbc:mariadb://" + context.db_in_Server + ":" + context.db_in_Port + "/"
						+ context.db_in_Database + "?" + properties_tDBRow_1;
				String dbUser_tDBRow_1 = context.db_in_Login;

				final String decryptedPassword_tDBRow_1 = context.db_in_Password;
				...
				query_tDBRow_1 = "SELECT @@SQL_MODE as mode";
...
// Start of branch "row5"
				if (row5 != null) {
					...
					java.sql.ResultSet re_tParseRecordSet_1 = (java.sql.ResultSet) row5.response;
					...
					while (true) {
						...
						res_str_tParseRecordSet_1 = re_tParseRecordSet_1.getString("mode");
						if (res_str_tParseRecordSet_1 != null) {
							row6.mode = res_str_tParseRecordSet_1.trim();
						} else {
							// row6.mode = res_str_tParseRecordSet_1;
							row6.mode = null;
						}
...
///////////////////////		
						...
						if (row6.mode != null) { //
							row_tLogRow_2[0] = String.valueOf(row6.mode);
...
///////////////////////    			
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		...
		public String co_login;

		public String getCo_login() {
			return this.co_login;
		}
		...
		public void copyDataTo(row4Struct other) {
			...
			other.co_mail = this.co_mail;
			other.co_tel = this.co_tel;
			other.co_mobile = this.co_mobile;
			other.co_title = this.co_title;
			other.co_function = this.co_function;
			other.co_login = this.co_login;
			other.co_password = this.co_password;
			other.co_language = this.co_language;
			other.co_is_active = this.co_is_active;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FORMATION_S25_output_db) {
				...
				try {
					...
					this.co_title = readString(dis);

					this.co_function = readString(dis);

					this.co_login = readString(dis);

					this.co_password = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.co_login, dos);

				// String

				writeString(this.co_password, dos);
		...
		public String toString() {
			...
			sb.append(",co_title=" + co_title);
			sb.append(",co_function=" + co_function);
			sb.append(",co_login=" + co_login);
			sb.append(",co_password=" + co_password);
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_2 = "contact";
				...
				String properties_tDBOutput_2 = context.db_in_AdditionalParams;
				...
				String url_tDBOutput_2 = "jdbc:mariadb://" + context.db_in_Server + ":" + context.db_in_Port + "/"
						+ context.db_in_Database + "?" + properties_tDBOutput_2;

				String driverClass_tDBOutput_2 = "org.mariadb.jdbc.Driver";

				String dbUser_tDBOutput_2 = context.db_in_Login;

				final String decryptedPassword_tDBOutput_2 = context.db_in_Password;
				...
				String insert_tDBOutput_2 = "INSERT INTO `" + "contact"
						+ "` (`co_id`,`co_name`,`co_firstname`,`co_mail`,`co_tel`,`co_mobile`,`co_title`,`co_function`,`co_login`,`co_password`,`co_language`,`co_is_active`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				util_tLogRow_1
						.addRow(new String[] { "co_id", "co_name", "co_firstname", "co_mail", "co_tel", "co_mobile",
								"co_title", "co_function", "co_login", "co_password", "co_language", "co_is_active", });
...
///////////////////////    			
				...
				int limit_tFileInputDelimited_2 = 130;
				try {

					Object filename_tFileInputDelimited_2 = context.data_dir + "users2000.csv";
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								context.data_dir + "users2000.csv", "ISO-8859-15", ";", "\n", false, 1, 0,
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							row2.login = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 9;

							row2.password = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
							...
							row2.active = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
// Start of branch "row2"
						if (row2 != null) {
							...
							row3.co_id = row2.id;
							row3.co_name = row2.name;
							row3.co_firstname = row2.firstname;
							row3.co_mail = row2.email;
							row3.co_tel = row2.phone;
							row3.co_mobile = row2.mobile;
							row3.co_title = row2.title;
							row3.co_function = row2.function;
							row3.co_login = row2.login;
							row3.co_password = row2.password;
							row3.co_language = row2.lang;
							row3.co_is_active = row2.active;
...
///////////////////////		
							...
							row_tLogRow_1[0] = String.valueOf(row3.co_id);

							if (row3.co_name != null) { //
								row_tLogRow_1[1] = String.valueOf(row3.co_name);

							} //

							if (row3.co_firstname != null) { //
								row_tLogRow_1[2] = String.valueOf(row3.co_firstname);

							} //

							if (row3.co_mail != null) { //
								row_tLogRow_1[3] = String.valueOf(row3.co_mail);

							} //

							if (row3.co_tel != null) { //
								row_tLogRow_1[4] = String.valueOf(row3.co_tel);

							} //

							if (row3.co_mobile != null) { //
								row_tLogRow_1[5] = String.valueOf(row3.co_mobile);

							} //

							if (row3.co_title != null) { //
								row_tLogRow_1[6] = String.valueOf(row3.co_title);

							} //

							if (row3.co_function != null) { //
								row_tLogRow_1[7] = String.valueOf(row3.co_function);

							} //

							if (row3.co_login != null) { //
								row_tLogRow_1[8] = String.valueOf(row3.co_login);

							} //

							if (row3.co_password != null) { //
								row_tLogRow_1[9] = String.valueOf(row3.co_password);

							} //

							if (row3.co_language != null) { //
								row_tLogRow_1[10] = String.valueOf(row3.co_language);

							} //

							if (row3.co_is_active != null) { //
								row_tLogRow_1[11] = String.valueOf(row3.co_is_active);
...
///////////////////////    			
							...
							pstmt_tDBOutput_2.setLong(1, row4.co_id);

							if (row4.co_name == null) {
								pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(2, row4.co_name);
							}

							if (row4.co_firstname == null) {
								pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(3, row4.co_firstname);
							}

							if (row4.co_mail == null) {
								pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(4, row4.co_mail);
							}

							if (row4.co_tel == null) {
								pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(5, row4.co_tel);
							}

							if (row4.co_mobile == null) {
								pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(6, row4.co_mobile);
							}

							if (row4.co_title == null) {
								pstmt_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(7, row4.co_title);
							}

							if (row4.co_function == null) {
								pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(8, row4.co_function);
							}

							if (row4.co_login == null) {
								pstmt_tDBOutput_2.setNull(9, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(9, row4.co_login);
							}

							if (row4.co_password == null) {
								pstmt_tDBOutput_2.setNull(10, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(10, row4.co_password);
							}

							if (row4.co_language == null) {
								pstmt_tDBOutput_2.setNull(11, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(11, row4.co_language);
							}

							if (row4.co_is_active == null) {
								pstmt_tDBOutput_2.setNull(12, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(12, row4.co_is_active);
							}
					...
					if (!((Object) (context.data_dir + "users2000.csv") instanceof java.io.InputStream)) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final output_db output_dbClass = new output_db();

		int exitCode = output_dbClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = output_db.class.getClassLoader()
					.getResourceAsStream("formation_s25/output_db_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = output_db.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : output_db");
		}
...
/************************************************************************************************
 * 130074 characters generated by Talend Open Studio for Data Integration on the
 * 22 juin 2022 à 09:18:30 CEST
 ************************************************************************************************/