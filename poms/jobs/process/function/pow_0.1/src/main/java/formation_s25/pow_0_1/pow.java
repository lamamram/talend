...
/**
 * Job: pow Purpose: calculer x**y et retourner le résultat<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class pow implements TalendJob {
...
public Integer getExp(){
	...
	private final String jobName = "pow";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(pow.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_FORMATION_S25_pow = new byte[0];
    static byte[] commonByteArray_FORMATION_S25_pow = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_FORMATION_S25_pow) {
 ...
 */
    ...
    int result = (int)Math.pow(row1.nb, row1.exp);
...
String[] row_tBufferOutput_1=new String[]{"",};		
	    if(row2.result != null){
	            ...
	            row_tBufferOutput_1[0] = String.valueOf(row2.result);
 ...
 */
    ...
    public static void main(String[] args){
        final pow powClass = new pow();

        int exitCode = powClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = pow.class.getClassLoader().getResourceAsStream("formation_s25/pow_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = pow.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
                ...
                private void processContext_0() {
                        ...
                        if(context.getStringValue("nb") == null) {
                            ...
                            try{
                                ...
                                System.err.println(String.format("Null value will be used for context parameter %s: %s", "nb", e.getMessage()));
                                context.nb=null;
                            }
                        }
                        ...
                        if(context.getStringValue("exp") == null) {
                            ...
                            try{
                                ...
                                System.err.println(String.format("Null value will be used for context parameter %s: %s", "exp", e.getMessage()));
                                context.exp=null;
                            }
                        }
                } 
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("nb")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : pow");
        }
...
/************************************************************************************************
 *     41284 characters generated by Talend Open Studio for Data Integration 
 *     on the 24 juin 2022 à 16:27:29 CEST
 ************************************************************************************************/