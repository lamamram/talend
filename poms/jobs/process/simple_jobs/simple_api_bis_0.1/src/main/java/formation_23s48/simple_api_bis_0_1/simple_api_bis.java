...
package formation_23s48.simple_api_bis_0_1;
 ...
 * @status
 */
public class simple_api_bis implements TalendJob {
	...
	private final String jobName = "simple_api_bis";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					simple_api_bis.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(simple_api_bis.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		final static byte[] commonByteArrayLock_FORMATION_23S48_simple_api_bis = new byte[0];
		static byte[] commonByteArray_FORMATION_23S48_simple_api_bis = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FORMATION_23S48_simple_api_bis.length) {
					if (length < 1024 && commonByteArray_FORMATION_23S48_simple_api_bis.length == 0) {
						commonByteArray_FORMATION_23S48_simple_api_bis = new byte[1024];
					} else {
						commonByteArray_FORMATION_23S48_simple_api_bis = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FORMATION_23S48_simple_api_bis, 0, length);
				strReturn = new String(commonByteArray_FORMATION_23S48_simple_api_bis, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_FORMATION_23S48_simple_api_bis, 0, length);
				strReturn = new String(commonByteArray_FORMATION_23S48_simple_api_bis, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FORMATION_23S48_simple_api_bis) {
...
// expected response body
				...
				try {
					...
					webClient_tRESTClient_3.query("page", "2");
...
///////////////////////		
								...
								if (row4.id != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(row4.id));
								...
								if (row4.name != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(row4.name));
								...
								if (row4.email != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(row4.email));
								...
								if (row4.gender != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(row4.gender));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final simple_api_bis simple_api_bisClass = new simple_api_bis();

		int exitCode = simple_api_bisClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = simple_api_bis.class.getClassLoader()
					.getResourceAsStream("formation_23s48/simple_api_bis_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = simple_api_bis.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : simple_api_bis");
		}
...
/************************************************************************************************
 * 63227 characters generated by Talend Open Studio for Data Integration on the
 * December 1, 2023, 10:09:08 AM CET
 ************************************************************************************************/